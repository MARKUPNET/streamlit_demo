...
with tab3:
    ...
    with elements("dashboard"):
        ...
        layout = [
            ...
            dashboard.Item("first_item", 0, 0, 5, 2, moved=True),
            dashboard.Item("second_item", 5, 0, 5, 2, moved=True),
            dashboard.Item("third_item", 0, 2, 5, 2, moved=True),
        ]
...
# 参考サイト https://okld-gallery.streamlit.app/?p=elements